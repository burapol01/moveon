...
//        exerciseList.add(new Exercise(R.drawable.nex1, "ท่าที่ 1"));
//        exerciseList.add(new Exercise(R.drawable.nex2, "ท่าที่ 2"));
//        exerciseList.add(new Exercise(R.drawable.nex3, "ท่าที่ 3"));
//        exerciseList.add(new Exercise(R.drawable.nex2, "ท่าที่ 4"));
//        exerciseList.add(new Exercise(R.drawable.nex1, "ท่าที่ 5"));
