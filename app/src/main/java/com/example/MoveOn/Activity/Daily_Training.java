...
public class Daily_Training extends AppCompatActivity {
    ...
    private int exId = 0;
    private static final int CT25 = 1;
    ...
    private void showFinished() {
            ...
            call.enqueue(new Callback<ApiResponse<WorkoutDay>>() {
                ...
                public void onResponse(Call<ApiResponse<WorkoutDay>> call, Response<ApiResponse<WorkoutDay>> response) {
                    ...
                    if (body == null || !body.isSuccess()) {
                        Toast.makeText(Daily_Training.this, body != null ? body.getMessage() : "Save failed", Toast.LENGTH_SHORT).show();
                    }
                }
                ...
                public void onFailure(Call<ApiResponse<WorkoutDay>> call, Throwable t) {
                    progressDialog.dismiss();
                    Toast.makeText(Daily_Training.this, t.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
        } else {
            progressDialog.dismiss();
        ...
        Dialog dialog = new Dialog(Daily_Training.this);
    ...
    private void initData() {
        list.add(new Exercise(R.drawable.ext25_1, "Rip'T Circuit"));
    }
