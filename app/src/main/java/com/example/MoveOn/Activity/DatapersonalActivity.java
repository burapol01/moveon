...
public class DatapersonalActivity extends AppCompatActivity {
    ...
    public void save2() {
        Button btnDatapn = findViewById(R.id.btn_datapn);
        btnDatapn.setOnClickListener(v -> {
            ProgressDialog progressDialog = new ProgressDialog(DatapersonalActivity.this);
            ...
            Call<ApiResponse<Datapersonal>> call = apiInterface.insertdatapn(
                    mtitelnameId,
                    name,
                    lastname,
                    msexId,
            ...
            call.enqueue(new Callback<ApiResponse<Datapersonal>>() {
                ...
                public void onResponse(Call<ApiResponse<Datapersonal>> call, Response<ApiResponse<Datapersonal>> response) {
                    ...
                    if (body != null && body.isSuccess()) {
                        ...
                        Toast.makeText(DatapersonalActivity.this, body != null ? body.getMessage() : "Save failed", Toast.LENGTH_SHORT).show();
                    }
                }
                ...
                public void onFailure(Call<ApiResponse<Datapersonal>> call, Throwable t) {
                    progressDialog.dismiss();
                    Toast.makeText(DatapersonalActivity.this, t.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
        });
    }
